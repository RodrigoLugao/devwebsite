        ...
        <div className="d-none d-md-flex justify-content-between">
          <section className="w-25">
            ...
            <p className="text-white-50">
              Desde 1995, a Simas Auto é sinônimo de qualidade e confiança no
              mercado automotivo, oferecendo uma ampla variedade de carros e
              motos que combinam desempenho, segurança e inovação.
            </p>
          </section>
